...
// Setter
    ...
    for(var i = 0; i < result.results.length; i++) {
        $output.append("<li class='ui-li-has-alt ui-li-has-thumb ui-first-child'><a href='index.html' class='ui-btn'><img src='" + result.results[i].artworkUrl60 + "'><h3>" + result.results[i].trackName + "</h3><p>" + result.results[i].artistName + "</p></a></li>");
